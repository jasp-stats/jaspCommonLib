...
public:
	...
	virtual const std::vector<std::string> & upgradeMsgsForOption(const std::string& name) const	{ return emptyStringVec;	}
...
protected:
	...
	static const std::vector<std::string>		emptyStringVec;
};
